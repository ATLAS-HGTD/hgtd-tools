...
class CTkScrollableDropdownFrame(customtkinter.CTkFrame):
    ...
    # new version from this issue comment: https://github.com/Akascape/CTkScrollableDropdown/issues/48#issuecomment-2253716373
    def place_dropdown_old(self):
        ...
        print('self.attach.winfo_x()',self.attach.winfo_x())
        print('self.attach.winfo_y()',self.attach.winfo_y())
